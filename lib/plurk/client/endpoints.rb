  ...
  class Client
    module Endpoints
      ...
      def get_plurks offset = nil
        ...
        resp["plurks"].map! { |i| Plurk::Plurk.new(i) }
        resp["plurk_users"].map! { |k,v| Plurk::User.new(v) }
        return resp
      end
      ...
      def check_token
        Plurk::OAuthToken.new request "/APP/checkToken"
      end

      def expire_token
        Plurk::OAuthToken.new request "/APP/expireToken"
      end
